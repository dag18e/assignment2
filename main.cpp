...
int main() {
    ...
    vehiclesArray[6] = new Jet("Boeing", "747", "Rocket", 4);
    vehiclesArray[7] = new Jet();
    vehiclesArray[8] = new Skateboard();
    vehiclesArray[9] = new Skateboard("ChonkyBoards", "ChonkyPenguin");
    vehiclesArray[10] = new Helicopter();
    vehiclesArray[11] = new Helicopter("Robinson", "R22", "GoGoJuice", 1, 2, 1);
